...
{
    function error(string $message = 'Something went wrong', int $statusCode = 400, string $errorCode = null){
...
{
    function notFound(string $message = 'The requested resource was not found.', int $statusCode = 404, string $errorCode = null){
        return response()->json(['status'=>'failed', 'message'=>$message, 'errorCode'=>$errorCode], $statusCode);
    }
}
...
{
    function badRequest(string $message = 'Invalid Request', int $statusCode = 400, string $errorCode = null){
        return response()->json(['status'=>'failed', 'message'=>$message, 'errorCode'=>$errorCode], $statusCode);
    }
}
...
{
    function unAuthenticated(string $message = 'Authentication required to access this feature', int $statusCode = 401, string $errorCode = null){
        return response()->json(['status'=>'failed', 'message'=>$message, 'errorCode'=>$errorCode], $statusCode);
    }
}
...
{
    function unAuthorized(string $message = 'You are not authorized to perform this action', int $statusCode = 403, string $errorCode = null){
        return response()->json(['status'=>'failed', 'message'=>$message, 'errorCode'=>$errorCode], $statusCode);
    }
}
...
{
    function tooManyRequest(string $message = 'You have reached your request limit.', int $statusCode = 429, string $errorCode = null){
        return response()->json(['status'=>'failed', 'message'=>$message, 'errorCode'=>$errorCode], $statusCode);
    }
}
...
{
    function methodNotAllowed(string $message = 'The HTTP method used is not allowed', int $statusCode = 405, string $errorCode = null){
        return response()->json(['status'=>'failed', 'message'=>$message, 'errorCode'=>$errorCode], $statusCode);
    }
}
...
{
    function failedValidation(string $message = 'Your request has failed at least one validation check.', int $statusCode = 422, string $errorCode = null){
        return response()->json(['status'=>'failed', 'message'=>$message, 'errorCode'=>$errorCode], $statusCode);
    }
}
...
{
    function serviceUnavailable(string $message = 'Something went wrong', int $statusCode = 503, string $errorCode = null){
        return response()->json(['status'=>'failed', 'message'=>$message, 'errorCode'=>$errorCode], $statusCode);
    }
}
...
{
    function dbError(string $message = 'Error saving record!', int $statusCode = 500, string $errorCode = null){
        return response()->json(['status'=>'failed', 'message'=>$message, 'errorCode'=>$errorCode], $statusCode);
    }
}
